...
Public Class Form1
    ...
    Private Sub StartThread(i As Integer, AlreadyExists As Boolean)
        ...
        If ListFiles.Items.Count > 0 Then
            ...
            If Not AlreadyExists Then
                ...
                f.UploadToElastic = True
                f.URLElastic = ElasticInstance.Text
                f.IndexName = IndexName.Text
                f.ObjectName = ObjectName.Text
                f.Number = i
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ElasticInstance.Text = "http://localhost:9200/logs/tj/"
        ...
        s = RestoreIniValue("CurrentValues", "ElasticInstance")
        If Not s = "" Then
            ElasticInstance.Text = s
        End If

        s = RestoreIniValue("CurrentValues", "IndexName")
        If Not s = "" Then
            IndexName.Text = s
        End If

        s = RestoreIniValue("CurrentValues", "ObjectName")
        If Not s = "" Then
            ObjectName.Text = s
        End If
        ...
        s = RestoreIniValue("CurrentValues", "DeleteIndexBeforeUploads").Trim
        If Not s = "" Then
            DeleteIndexBeforeUploads.Checked = (s.ToLower = "true")
        End If
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim f As TJReader.TJ.LoaderTj
        If DeleteIndexBeforeUploads.Checked Then
            f = New TJReader.TJ.LoaderTj
            f.UploadToElastic = True
            f.URLElastic = ElasticInstance.Text
            f.IndexName = IndexName.Text
            f.ObjectName = ObjectName.Text
            f.DeleteElasticIndexBeforeUploads = DeleteIndexBeforeUploads.Checked
            f.UpdateElasticTypes()
            f = Nothing
        End If
    ...
    Private Sub Form1_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        ...
        Param.AddSection("CurrentValues").AddKey("ElasticInstance").Value = ElasticInstance.Text
        Param.AddSection("CurrentValues").AddKey("ObjectName").Value = ObjectName.Text
        Param.AddSection("CurrentValues").AddKey("IndexName").Value = IndexName.Text
        Param.AddSection("CurrentValues").AddKey("ParallelsExec").Value = ParallelsExec.Value.ToString
        Param.AddSection("CurrentValues").AddKey("DeleteIndexBeforeUploads").Value = DeleteIndexBeforeUploads.Checked
